...
style = ttk.Style()
style.configure("TButton", padding=10, relief="flat", font=("Helvetica", 12, "bold"),
                background="#007ACC", foreground="white", borderwidth=1)
style.map("TButton", background=[("active", "#005A9E")])  # Button color change on hover

# Title label
title_label = Label(root, text="🎶 Music Player", font=("Helvetica", 22, "bold"), fg="#00CCFF", bg="#1E1E1E")
title_label.pack(pady=20)

# Song label
song_label = Label(root, text="No song loaded", font=("Helvetica", 16), fg="#FFFFFF", bg="#1E1E1E")
song_label.pack(pady=10)

# Create a frame for listbox and scrollbar
frame_listbox = Frame(root, bg="#1E1E1E")
...
load_button = ttk.Button(button_frame, text="Load Music", command=load_music, style="TButton")
...
resume_button = ttk.Button(button_frame, text="Resume", command=resume_music, style="TButton")
